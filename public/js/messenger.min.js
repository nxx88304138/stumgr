...
window.Messenger._ = function() {
    ...
    h = u.each = u.forEach = function(e, t, n) {
        if (null != e) if (i && e.forEach === i) e.forEach(t, n);
            ...
            for (var s = 0,
            r = e.length; r > s; s++) if (t.call(n, e[s], s, e) === c) return
    ...
    u.filter = u.select = function(e, t, n) {
        var s = [];
        return null == e ? s: o && e.filter === o ? e.filter(t, n) : (h(e,
        function(e, r, i) {
            t.call(n, e, r, i) && (s[s.length] = e)
        }), s)
    },
    h(["Arguments", "Function", "String", "Number", "Date", "RegExp"],
    function(e) {
        u["is" + e] = function(t) {
    ...
    var e = function() {
        ...
        s = {
            ...
            off: function(e, n, s) {
                ...
                if (!e && !n && !s) return this._events = {},
                this;
                for (a = e ? [e] : _.keys(this._events), l = 0, u = a.length; u > l; l++) if (e = a[l], r = this._events[e]) {
                    if (o = [], n || s) for (c = 0, h = r.length; h > c; c++) i = r[c],
                    (n && n !== i.callback && n !== i.callback._callback || s && s !== i.context) && o.push(i);
                    this._events[e] = o
                }
                return this
            },
            ...
            stopListening: function(e, t, n) {
                ...
                if (s) {
                    if (e) e.off(t, "object" == typeof t ? this: n, this),
...
function() {
    var e, t, n, s, r, i, o, a, l, u, c, h = {}.hasOwnProperty,
    p = function(e, t) {
        function n() {
            this.constructor = e
        }
        ...
        t.prototype.delegateEvents = function(e) {
            ...
            if (e || (e = i.result(this, "events"))) {
                ...
                for (s in e) {
                    ...
                    "" === a ? l.push(this.jqon(n, o)) : l.push(this.jqon(n, a, o))
                }
                return l
            }
        },
    ...
    o = function(t) {
        ...
        n.prototype.hide = function() {
            var e;
            if (this.rendered) return this.$message.addClass("messenger-hidden"),
            e = this.shown,
            this.shown = !1,
        ...
        n.prototype.update = function(t) {
            ...
            this.delegateEvents(),
            this.checkClickable(),
            this.options.hideAfter ? (this.$message.addClass("messenger-will-hide-after"), null != this._hideTimeout && clearTimeout(this._hideTimeout), this._hideTimeout = setTimeout(function() {
                return s.hide()
            },
            1e3 * this.options.hideAfter)) : this.$message.removeClass("messenger-will-hide-after"),
            this.options.hideOnNavigate ? (this.$message.addClass("messenger-will-hide-on-navigate"), null != ("undefined" != typeof Backbone && null !== Backbone ? Backbone.history: void 0) && Backbone.history.on("route",
            function() {
                return s.hide()
        ...
        n.prototype.template = function(t) {
            ...
            for (o = e("<div class='messenger-message message alert " + t.type + " message-" + t.type + " alert-" + t.type + "'>"), t.showCloseButton && (r = e('<button type="button" class="close" data-dismiss="alert">&times;</button>'), r.click(function() {
                return p.cancel(),
                !0
            }), o.append(r)), a = e('<div class="messenger-message-inner">' + t.message + "</div>"), o.append(a), t.actions.length && (s = e('<div class="messenger-actions">')), h = t.actions, u = 0, c = h.length; c > u; u++) l = h[u],
            n = e("<span>"),
        ...
        n.prototype.render = function() {
            var t;
            if (!this.rendered) return this._hasSlot || (this.setElement(this.messenger._reserveMessageSlot(this)), this._hasSlot = !0),
            t = e.extend({},
            this.options, {
    ...
    r = function(e) {
        ...
        t.prototype.startCountdown = function(e, t) {
            var n, s, r, i, o = this;
            if (null == this._timers[e]) return n = this.$message.find("[data-action='" + e + "'] .messenger-phrase"),
            s = null != (i = t.delay) ? i: 3,
            10 >= s ? (this.$message.removeClass("messenger-retry-later"), this.$message.addClass("messenger-retry-soon")) : (this.$message.removeClass("messenger-retry-soon"), this.$message.addClass("messenger-retry-later")),
            r = function() {
                var i;
                return n.text(o.renderPhrase(t, s)),
                s > 0 ? (i = Math.min(s, 1), s -= i, o._timers[e] = setTimeout(r, 1e3 * i)) : (o.$message.removeClass("messenger-retry-soon messenger-retry-later"), delete o._timers[e], t.action())
            },
            r()
        },
        t
    ...
    a = function(t) {
        ...
        n.prototype._reserveMessageSlot = function(t) {
            ...
            for (n = e("<li>"), n.addClass("messenger-message-slot"), this.$el.prepend(n), this.history.push({
                msg: t,
                $slot: n
            }), this._enforceIdConstraint(t), t.on("update",
            function() {
                return r._enforceIdConstraint(t)
            }); this.options.maxMessages && this.history.length > this.options.maxMessages;) s = this.history.shift(),
            s.msg.remove(),
            s.$slot.remove();
            return n
        },
        n.prototype._enforceIdConstraint = function(e) {
            ...
            if (null != e.options.id) for (i = this.history, n = 0, s = i.length; s > n; n++) if (t = i[n], r = t.msg, null != r.options.id && r.options.id === e.options.id && e !== r) {
                if (e.options.singleton) return e.hide(),
                void 0;
                r.hide()
            }
        },
        n.prototype.newMessage = function(e) {
            ...
            return null == e && (e = {}),
            e.messenger = this,
            o = null != (n = null != (s = Messenger.themes[null != (i = e.theme) ? i: this.options.theme]) ? s.Message: void 0) ? n: r,
            t = new o(e),
            t.on("show",
            function() {
        ...
        n.prototype.updateMessageSlotClasses = function() {
            var e, t, n, s, r, i, o;
            for (s = !0, t = null, e = !1, o = this.history, r = 0, i = o.length; i > r; r++) n = o[r],
            n.$slot.removeClass("messenger-first messenger-last messenger-shown"),
            n.msg.shown && n.msg.rendered && (n.$slot.addClass("messenger-shown"), e = !0, t = n, s && (s = !1, n.$slot.addClass("messenger-first")));
            return null != t && t.$slot.addClass("messenger-last"),
            this.$el["" + (e ? "remove": "add") + "Class"]("messenger-empty")
        },
        n.prototype.hideAll = function() {
            var e, t, n, s, r;
            for (s = this.history, r = [], t = 0, n = s.length; n > t; t++) e = s[t],
            r.push(e.msg.hide());
            return r
        },
    ...
    t = function(t) {
        ...
        n.prototype.hookBackboneAjax = function(t) {
            ...
            null != Backbone.ajax ? (Backbone.ajax._withoutMessenger && (Backbone.ajax = Backbone.ajax._withoutMessenger), (null == t.action || t.action === this.doDefaults.action) && (t.action = Backbone.ajax), n._withoutMessenger = Backbone.ajax, Backbone.ajax = n) : Backbone.sync = i.wrap(Backbone.sync,
            function() {
                var t, s, r;
        ...
        n.prototype._normalizeResponse = function() {
            var e, t, n, s, r, o, a;
            for (n = arguments.length >= 1 ? d.call(arguments, 0) : [], s = null, r = null, e = null, o = 0, a = n.length; a > o; o++) t = n[o],
            "success" === t || "timeout" === t || "abort" === t ? s = t: null != (null != t ? t.readyState: void 0) && null != (null != t ? t.responseText: void 0) ? r = t: i.isObject(t) && (e = t);
            return [s, e, r]
        },
        n.prototype.run = function() {
            var t, n, s, r, o, a, l, u, c, h, p, g, m, v, y, _, w = this;
            if (l = arguments[0], h = arguments[1], t = arguments.length >= 3 ? d.call(arguments, 2) : [], null == h && (h = {}), l = e.extend(!0, {},
            this.messageDefaults, this.doDefaults, null != l ? l: {}), s = this._parseEvents(l.events), r = function(e, t) {
                var n;
                return n = l[e + "Message"],
                i.isFunction(n) ? n.call(w, e, t) : n
            },
            u = null != (y = l.messageInstance) ? y: this.newMessage(l), null != l.id && (u.options.id = l.id), null != l.progressMessage && u.update(e.extend({},
            l, {
                message: r("progress", null),
                type: "info"
            })), a = {},
            i.each(["error", "success"],
            function(n) {
                var o;
                return o = h[n],
                a[n] = function() {
                    ...
                    b = w._normalizeResponse.apply(w, v),
                    m = b[0],
                    a = b[1],
                    _ = b[2],
                    "success" === n && null == u.errorCount && l.showSuccessWithoutError === !1 && (l.successMessage = null),
                    "error" === n && (null == (x = l.errorCount) && (l.errorCount = 0), l.errorCount += 1),
                    p = l.returnsPromise ? v[0] : "function" == typeof o ? o.apply(null, v) : void 0,
                    y = w._getHandlerResponse(p),
                    i.isString(y) && (y = {
                        message: y
                    }),
                    "error" !== n || 0 !== (null != _ ? _.status: void 0) && "abort" !== m ? "error" === n && null != l.ignoredErrorCodes && (M = null != _ ? _.status: void 0, f.call(l.ignoredErrorCodes, M) >= 0) ? (u.hide(), void 0) : (c = {
                        message: r(n, _),
                        type: n,
                        events: null != (C = s[n]) ? C: {},
                    ...
                    g = e.extend({},
                    l, c, y), "number" == typeof(null != (k = g.retry) ? k.allow: void 0) && g.retry.allow--, "error" === n && (null != _ ? _.status: void 0) >= 500 && (null != ($ = g.retry) ? $.allow: void 0) ? (null == g.retry.delay && (g.retry.delay = 4 > g.errorCount ? 10 : 300), g.hideAfter && (null == (E = g._hideAfter) && (g._hideAfter = g.hideAfter), g.hideAfter = g._hideAfter + g.retry.delay), g._retryActions = !0, g.actions = {
                        retry: {
                            label: "retry now",
            ...
            }), !l.returnsPromise) for (g in a) o = a[g],
            c = h[g],
            h[g] = o;
            for (u._actionInstance = l.action.apply(l, [h].concat(d.call(t))), l.returnsPromise && u._actionInstance.then(a.success, a.error), p = ["done", "progress", "fail", "state", "then"], m = 0, v = p.length; v > m; m++) n = p[m],
            null != u[n] && delete u[n],
            u[n] = null != (_ = u._actionInstance) ? _[n] : void 0;
            return u
        },
    ...
    e.fn.messenger = function() {
        ...
        null == r && (r = {}),
        n = this,
        null != r && i.isString(r) ? (h = n.data("messenger"))[r].apply(h, s) : (l = r, null == n.data("messenger") && (a = null != (u = null != (c = Messenger.themes[l.theme]) ? c.Messenger: void 0) ? u: t, n.data("messenger", o = new a(e.extend({
            el: n
        },
    ...
    window.Messenger._call = function(t) {
        ...
        l.$el.addClass(o = "" + l.className + " " + t.extraClasses),
        l._addedClasses = o,
        l
    },
    e.extend(Messenger, {
