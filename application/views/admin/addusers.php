						...
						<table class="table no-border">
							...
							<tr class="no-border">
								<td class="text-center">
									<input id="upload" type="submit" class="btn btn-primary" value="确认" disabled="disabled" />
...
<script type="text/javascript" src="<?php echo base_url(); ?>public/js/bootstrap.file-input.js"></script>
<script type="text/javascript">
